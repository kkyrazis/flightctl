...
func NewDeviceLabelReconciliationLogic(log logrus.FieldLogger, reconciler *labelsyncmappingservice.Reconciler, orgID uuid.UUID, event domain.Event) (DeviceLabelReconciliationLogic, error) {
	if reconciler == nil {
