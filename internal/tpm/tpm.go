...
func createSealPCRSelection() *tpm2.TPMLPCRSelection {
	// Byte 0: PCR 0 = bit 0 = 0x01
	// Byte 0: PCR 7 = bit 7 = 0x80
	// Byte 1: PCR 14-8 = bit 6 = 0x40
	return createPCRSelection([3]byte{0x81, 0x40, 0x00})
}
